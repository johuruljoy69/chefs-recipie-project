        ...
        <div className='Blog' ref={ref}>
            ...
            <div className='text-center mb-20'>
                <Pdf targetRef={ref} filename="blog-page.pdf">
                    {({ toPdf }) => <button onClick={toPdf} className='px-7 py-3 text-white text-center mx-auto font-semibold rounded-lg bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:from-pink-500 hover:to-yellow-500 '>Download pdf file</button>}
                </Pdf>                
            </div>
        </div>
    );
